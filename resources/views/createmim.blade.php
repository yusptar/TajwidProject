...
@section('content')
<h5 class="card-title">Tambah Data Mim Sukun</h5>
<main id="main" data-aos="fade-in">
    <section id="events" class="events">
        <div class="container" data-aos="fade-up">
            <form action="/managemim/createmim" method="post">
                @csrf
                ...
                <button type="submit" name="createmim" class="btn btn-primary float-right">Tambah Data</button>
            </form>
        </div>
    </section>
</main>
